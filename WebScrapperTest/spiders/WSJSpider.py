...
class ScrappySpider(scrapy.Spider):
    ...
    def save_data(self, url, website_text):
        ...
        save_path = 'C:/Users/victo/Desktop/Proyectos/NewsCurator/rawFolders/rawWSJ'
        completeNametxt = os.path.join(save_path, "rawWSJ"+str(self.counter)+".txt")
