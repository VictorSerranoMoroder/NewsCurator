...
class ScrappySpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for link in links:
            if ("theguardian.com/world" in link or "theguardian.com/global" in link):
    ...
    def save_data(self, url, website_text):
        ...
        save_path = 'C:/Users/victo/Desktop/Proyectos/NewsCurator/rawFolders/rawGUA'
        completeNametxt = os.path.join(save_path, "rawGUA"+str(self.counter)+".txt")
